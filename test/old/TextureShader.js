    ...
    var TextureShader = function(gl) {
        ...
        var fshader = [
            ...
            'void main() {',
                ...
                'gl_FragColor = texture2D(texture, v_Uv) * (u_AmbientColor * u_Ambient + u_DirectionalColor * dL + u_PointColor * pL);',
            '}'
        ].join("\n");

        TextureShader.superClass.constructor.call(this, gl, vshader, fshader);
    }

    zen3d.inherit(TextureShader, zen3d.Shader);

    zen3d.TextureShader = TextureShader;
})();
