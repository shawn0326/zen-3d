...
directionalLight.euler.set(Math.PI / 2 + Math.PI / 3, 0, 0);
...
function loop() {
    ...
    directionalLight.position.z = Math.sin(count * 0.03) * 300;

    directionalLight.euler.x = Math.PI / 2 + Math.PI / 3 * Math.sin(count * 0.03);
}
