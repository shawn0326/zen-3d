(function (global, factory) {
    ...
    VOXLoader.prototype.parse = function(uint8Array) {
        ...
        try {
            ...
            if (dataHolder.data.palette.length === 0) {
                ...
                dataHolder.data.palette = VOXDefaultPalette;
            } else {
    ...
    */
    ...
    function VOXMeshBuilder(voxelData, param) {
    	if (!VOXMeshBuilder.textureFactory) VOXMeshBuilder.textureFactory = new VOXTextureFactory();
    ...
    VOXMeshBuilder.prototype._build = function() {
    	...
    	if (this.vertexColor) {
    		this.material.vertexColors = zen3d.VERTEX_COLOR.RGBA;
    	} else {
