...
function cloneUniforms$1(uniforms_src) {
    var uniforms_dst = {};
...
function ShaderPostPass(shader) {
    ...
    this.uniforms = cloneUniforms$1(shader.uniforms);
...
export { Color3, FileLoader, TextureCube, Light, RenderTargetBase, LineMaterial, Matrix3, SpotLight, NumberKeyframeTrack, Plane, Mesh, ImageLoader, Vector4, EnvironmentMapPass, AmbientLight, StringKeyframeTrack, LineDashedMaterial, Box3, InstancedGeometry, PlaneGeometry, InstancedInterleavedBuffer, SphereGeometry, TextureDepth, PointsMaterial, WebGLTexture, CubeGeometry, AnimationMixer, WebGLGeometry, Sphere, PBRMaterial, InstancedBufferAttribute, LightCache, Object3D, Points, Fog, VectorKeyframeTrack, QuaternionKeyframeTrack, LambertMaterial, Matrix4, BasicMaterial, SpotLightShadow, ShaderChunk, TextureBase, Geometry, WebGLProgram, Spherical, RenderTargetCube, PointLight, PointLightShadow, LightShadow, BooleanKeyframeTrack, WebGLProperties, RenderList, Triangle, ShaderMaterial, KeyframeClip, BufferAttribute, DistanceMaterial, RenderTarget2D, Skeleton, TGALoader, Material, ShaderLib, ShaderPostPass, Euler, KeyframeTrack, CylinderGeometry, Camera, ShadowMapPass, LineLoopMaterial, Box2, Ray, Group, DirectionalLightShadow, SkinnedMesh, Vector2, DirectionalLight, DepthMaterial, Bone, TextureData, PropertyBindingMixer, Raycaster, WebGLState, Renderer, Scene, EventDispatcher, RenderTargetBack, InterleavedBuffer, Vector3, WebGLUniform, FogExp2, InterleavedBufferAttribute, WebGLCapabilities, WebGLAttribute, PhongMaterial, Line, Curve, Quaternion, ColorKeyframeTrack, Frustum, Texture2D, WebGLCore, generateUUID, isMobile, isWeb, createCheckerBoardPixels, isPowerOfTwo, nearestPowerOfTwo, nextPowerOfTwo, cloneUniforms, halton, MATERIAL_TYPE, WEBGL_BUFFER_USAGE, BLEND_FACTOR, DRAW_MODE, FOG_TYPE, WEBGL_PIXEL_FORMAT, WEBGL_TEXTURE_TYPE, LIGHT_TYPE, ENVMAP_COMBINE_TYPE, SHADING_TYPE, WEBGL_UNIFORM_TYPE, DRAW_SIDE, OBJECT_TYPE, CULL_FACE_TYPE, BLEND_TYPE, WEBGL_TEXTURE_FILTER, SHADOW_TYPE, TEXEL_ENCODING_TYPE, BLEND_EQUATION, WEBGL_TEXTURE_WRAP, WEBGL_PIXEL_TYPE, WEBGL_ATTRIBUTE_TYPE };
