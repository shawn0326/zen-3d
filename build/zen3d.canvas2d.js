...
(function (global, factory) {
	...
	(global = global || self, factory(global.zen3d = global.zen3d || {}));
	 ...
	 * @class
	 */
	var Canvas2DMaterial = /*@__PURE__*/(function (superclass) {
		...
		if ( superclass ) Canvas2DMaterial.__proto__ = superclass;
		Canvas2DMaterial.prototype = Object.create( superclass && superclass.prototype );
		Canvas2DMaterial.prototype.constructor = Canvas2DMaterial;

		return Canvas2DMaterial;
	}(zen3d.Material));
	...
	var Canvas2D = /*@__PURE__*/(function (superclass) {
		...
		var prototypeAccessors = { isScreenCanvas: { configurable: true } };

		prototypeAccessors.isScreenCanvas.get = function () {
			return this._isScreenCanvas;
		};

		prototypeAccessors.isScreenCanvas.set = function (value) {
			this._isScreenCanvas = value;
		};

		Canvas2D.prototype.setSize = function setSize (width, height) {
		...
		Canvas2D.prototype.setRenderViewport = function setRenderViewport (x, y, w, h) {
			if (
		...
		Canvas2D.prototype.setScaleFactor = function setScaleFactor (value) {
		...
		Canvas2D.prototype.setScreenMatchMode = function setScreenMatchMode (mode) {
		...
		Canvas2D.prototype._updateCamera = function _updateCamera () {
			if (this._isScreenCanvas) {
		 ...
		 */
		Canvas2D.prototype.add = function add (object) {
		 ...
		 */
		Canvas2D.prototype.remove = function remove (object) {
		...
		Canvas2D.prototype.updateSprites = function updateSprites () {
		...
		// override
		Canvas2D.prototype.updateMatrix = function updateMatrix () {
		...
		Canvas2D.prototype.cacheSprites = function cacheSprites (object) {
			var sprites = this.sprites;
		...
		Object.defineProperties( Canvas2D.prototype, prototypeAccessors );
	...
	/**
	     ...
	     */
	Object2D.prototype.add = function add (object) {
		this.children.push(object);
		object.parent = this;
	};
	...
	/**
	     ...
	     */
	Object2D.prototype.remove = function remove (object) {
		var index = this.children.indexOf(object);
		if (index !== -1) {
			this.children.splice(index, 1);
		}
	...
	/**
	     * get object by name
	     */
	Object2D.prototype.getObjectByName = function getObjectByName (name) {
	...
	/**
	     ...
	     */
	Object2D.prototype.getObjectByProperty = function getObjectByProperty (name, value) {
	...
	/**
	     * update matrix
	     */
	Object2D.prototype.updateMatrix = function updateMatrix () {
	...
	Object2D.prototype.computeBoundingBox = function computeBoundingBox () {
		this.boundingBox.set(this.x, this.y, this.x + this.width, this.y + this.height);
	};

	var Sprite2D = /*@__PURE__*/(function (Object2D) {
		function Sprite2D() {
			Object2D.call(this);
			this.texture = null;
		}

		if ( Object2D ) Sprite2D.__proto__ = Object2D;
		Sprite2D.prototype = Object.create( Object2D && Object2D.prototype );
	...
	exports.Canvas2DMaterial = Canvas2DMaterial;
