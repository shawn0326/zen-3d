...
zen3d.FlyControls = function(object, domElement) {
	this.object = object;
	...
	this.tmpQuaternion = new zen3d.Quaternion();

	this.mouseStatus = 0;

	this.moveState = { up: 0, down: 0, left: 0, right: 0, forward: 0, back: 0, pitchUp: 0, pitchDown: 0, yawLeft: 0, yawRight: 0, rollLeft: 0, rollRight: 0 };
	this.moveVector = new zen3d.Vector3(0, 0, 0);
	this.rotationVector = new zen3d.Vector3(0, 0, 0);
	...
	this.update = function (delta) {
		...
		this.object.euler.setFromQuaternion(this.object.quaternion, this.object.euler.order);
