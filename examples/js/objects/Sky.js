...
zen3d.Sky = function(cubeTexture) {
	var geometry = new zen3d.CubeGeometry(1, 1, 1);

	var material = new zen3d.ShaderMaterial(zen3d.Sky.SkyShader);
...
zen3d.Sky.prototype = Object.create(zen3d.Mesh.prototype);
zen3d.Sky.prototype.constructor = zen3d.Sky;
