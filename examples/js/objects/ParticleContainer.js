...
zen3d.ParticleContainer = function(options) {
	...
	for (var i = 0; i < this.maxParticleCount; i++) {
		...
		vertices[i * 8 + 4] = this.decodeFloat(128, 128, 0, 0); // vel
		vertices[i * 8 + 5] = this.decodeFloat(0, 254, 0, 254); // color
	...
	this.material = new zen3d.ShaderMaterial(zen3d.ParticleContainer.GPUParticleShader);
	this.material.uniforms["tSprite"] = this.particleSpriteTex;
	this.material.uniforms["tNoise"] = this.particleNoiseTex;
	this.material.transparent = true;
	this.material.blending = zen3d.BLEND_TYPE.ADD;
	this.material.depthTest = true;
	this.material.depthWrite = false;
	this.material.drawMode = zen3d.DRAW_MODE.POINTS;

	this.frustumCulled = false;
}

zen3d.ParticleContainer.prototype = Object.assign(Object.create(zen3d.Object3D.prototype), {

	constructor: zen3d.ParticleContainer,
	...
	decodeFloat: function() {
		...
		return function decodeFloat(x, y, z, w) {
	...
	spawn: function() {
		...
		return function spawn(options) {
			...
			vertices[cursor * vertexSize + 4] = this.decodeFloat(velX, velY, velZ, turbulence); // velocity
			...
			if (b > 254) b = 254;
			if (b < 0) b = 0;
			vertices[cursor * vertexSize + 5] = this.decodeFloat(r, g, b, 254); // color
...
zen3d.ParticleContainer.GPUParticleShader = {
