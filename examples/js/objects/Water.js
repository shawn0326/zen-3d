...
zen3d.Water = function(geometry, options) {
	var scope = this;
	...
	var sunDirection = options.sunDirection !== undefined ? options.sunDirection : new zen3d.Vector3(0.70707, 0.70707, 0.0);
	var sunColor = new zen3d.Color3(options.sunColor !== undefined ? options.sunColor : 0xffffff);
	var waterColor = new zen3d.Color3(options.waterColor !== undefined ? options.waterColor : 0x7F7F7F);
	var eye = options.eye !== undefined ? options.eye : new zen3d.Vector3(0, 0, 0);
	var distortionScale = options.distortionScale !== undefined ? options.distortionScale : 20.0;
	var side = options.side !== undefined ? options.side : zen3d.DRAW_SIDE.FRONT;

	//

	var mirrorPlane = new zen3d.Plane();
	var normal = new zen3d.Vector3();
	var mirrorWorldPosition = new zen3d.Vector3();
	var cameraWorldPosition = new zen3d.Vector3();
	var rotationMatrix = new zen3d.Matrix4();
	var lookAtPosition = new zen3d.Vector3(0, 0, -1);
	var clipPlane = new zen3d.Vector4();

	var view = new zen3d.Vector3();
	var target = new zen3d.Vector3();
	var mirrorCameraUp = new zen3d.Vector3();
	var q = new zen3d.Vector4();

	var textureMatrix = new zen3d.Matrix4();

	var mirrorCamera = new zen3d.Camera();

	var renderTarget = new zen3d.RenderTarget2D(textureWidth, textureHeight);
	renderTarget.texture.minFilter = zen3d.WEBGL_TEXTURE_FILTER.LINEAR;
	renderTarget.texture.magFilter = zen3d.WEBGL_TEXTURE_FILTER.LINEAR;
	renderTarget.texture.format = zen3d.WEBGL_PIXEL_FORMAT.RGB;
	...
	zen3d.Mesh.call(scope, geometry, material);
...
zen3d.Water.prototype.constructor = zen3d.Water;