...
zen3d.Canvas2D = function(width, height, isScreenCanvas, screenMatchMode) {
	this.sharedMaterial = new zen3d.ShaderMaterial(canvas2dShader);
...
zen3d.Canvas2D.prototype = Object.assign(Object.create(zen3d.Mesh.prototype), {
	constructor: zen3d.Canvas2D,
...
zen3d.Canvas2D.SCREEN_MATCH_MODE = SCREEN_MATCH_MODE;