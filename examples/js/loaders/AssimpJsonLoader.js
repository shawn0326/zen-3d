...
zen3d.AssimpJsonLoader = function() {
	this.texturePath = "./";
}

zen3d.AssimpJsonLoader.prototype.load = function(url, onLoad, onProgress, onError) {
...
zen3d.AssimpJsonLoader.prototype.parseNodeTree = function(node) {
...
zen3d.AssimpJsonLoader.prototype.cloneNodeToBones = function(node, boneMap) {
...
zen3d.AssimpJsonLoader.prototype.parseSkeleton = function(meshName, bonesInfo, nodeTree, boneMap) {
	var meshParents = [];
...
zen3d.AssimpJsonLoader.prototype.parseAnimations = function(json, boneMap) {
...
zen3d.AssimpJsonLoader.prototype.parse = function(json) {
...
zen3d.AssimpJsonLoader.prototype.parseList = function(json, handler) {
...
zen3d.AssimpJsonLoader.prototype.parseMaterial = function(json) {
	...
	for (var key in json.properties) {
		...
		if (prop.key === '$tex.file') {
			...
			if (prop.semantic == 1) {
				...
				diffuseMap = zen3d.Texture2D.fromSrc(material_url);
				...
				var material_url = this.texturePath + prop.value;
				material_url = material_url.replace(/.\\/g, '');
				normalMap = zen3d.Texture2D.fromSrc(material_url);
				// TODO: read texture settings from assimp.
				// Wrapping is the default, though.
...
zen3d.AssimpJsonLoader.prototype.parseMesh = function(json) {
...
zen3d.AssimpJsonLoader.prototype.parseObject = function(json, node, meshes, materials, skeletons) {
...
zen3d.AssimpJsonLoader.prototype.extractUrlBase = function(url) {
	var parts = url.split('/');
	parts.pop();
